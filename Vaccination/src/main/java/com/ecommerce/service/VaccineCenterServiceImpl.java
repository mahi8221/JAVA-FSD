...
@Service
public class VaccineCenterServiceImpl implements VaccineCenterService { private final
...
@Override
public VaccineCenter addVaccineCenter(VaccineCenter vaccineCenter) { return
vaccineCenterRepository.save(vaccineCenter);
}

@Override
public void updateVaccineCenter(VaccineCenter updatedVaccineCenter) { VaccineCenter
existingCenter =
...
@Override
public VaccineCenter getVaccineCenterById(Long id) { return
vaccineCenterRepository.findById(id)
.orElseThrow(() -> new NotFoundException("Vaccine center not found"));
}

@Override
public List<VaccineCenter> getAllVaccineCenters() { return
vaccineCenterRepository.findAll();
}

public class NotFoundException extends RuntimeException { public
